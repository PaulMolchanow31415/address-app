...
public class DateUtil {
	...
	/**
	 * Возвращает полученную дату в виде хорошо отформатированной строки. Используется определённый выше
	...
	/**
	 * Преобразует строку, которая отформатирована по правилам шаблона {@link DateUtil#DATE_PATTERN} в объект
	 * {@link LocalDate}.
	 * <p>
